...
let faveColorFinder = (colorInput) => {
  if (colorInput === "Red"){
...
let printAllNames = (arrayOfNames) => {
...
let entirelyUppercase = (something) => {
  return something.toUpperCase()
}
console.log(entirelyUppercase("Hi, my name is Kylo."))
////////////////// PROBLEM 18 ////////////////////
/*
...
let frogBuyer2 = (gold1) => {
  return parseInt(gold1 / 3)
  } 
let totalFrogs2 = frogBuyer2(50)
...
let bathtubScope = ["sailormoonduck", "rubberduck", "duck"]

//This array should contain the variable names (as strings) accessible in the pond function.
let pondScope = ["pond duck", "duck"]